...
| RUNNING Loom without writing a host (the supplied host, the boot plan and the authority store, what the console can do, the two shutdowns) | guides/running-loom.md, guides/tools.md | GATE-05 | tests/test_admission.cpp | the standalone-hosting phase's own journey |
