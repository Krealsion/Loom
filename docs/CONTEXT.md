...
| ambient descriptors across the sandbox exec boundary (a host socket, file, pipe or terminal already open when a weave is mounted) | reference/capabilities.md#fresh-access-inherited-descriptors-and-the-exec-boundary | — | tests/test_isolation.cpp (C-2 cases) | COLD-2 finding C-2 |
