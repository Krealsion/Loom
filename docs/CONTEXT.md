...
| what the HOST remembers about the bus itself (the recorder: what one record holds, how delivery truth and retention truth are kept apart, the four honest answers to "what became of seq N", retention classes, the two budgets, the structural blacklist, the persistent log) | reference/recorder.md, reference/bounds.md#recorder-host-history | MSG-10 | tests/test_recorder.cpp | RTH-0 (what Zen remembered before), RTH-1 |
